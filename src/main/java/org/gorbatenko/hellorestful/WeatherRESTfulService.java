...
public class WeatherRESTfulService {
    ...
    //
    // http://localhost:8080/rest/weather/{location}/{date}
    // Example:
    // http://localhost:8080/rest/weather/chicago/2016-09-27
    // http://localhost:8080/rest/weather/hanoi/2016-09-27
    //
    @Path("{location}/{date}")
    @GET
    ...
    //
    // http://localhost:8080/rest/weather/{location}
    // Example:
    // http://localhost:8080/rest/weather/chicago
    // http://localhost:8080/rest/weather/hanoi
    //
    @Path("{location}")
    @GET
    @Produces("application/xml")
